...
- Поддерживает допуск короткого открытия глаз (настраивается), чтобы таймер не сбрасывался от микропробуждений.
...
- Переключатель `Игнорировать короткие открытия глаз` + настройка допуска 1-10 секунд.
